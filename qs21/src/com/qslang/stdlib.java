...
// ----------------------------------------
// -- {lim: test: OK: OK .. OK: FAIL}
class stdlib_lim extends CustomFunction
{
	@Override
	public String Function (qs21 vm)
	{
		String val = vm.v("lim-0");
		int len = vm.d("lim-len");
		boolean success = false;
		for (int i = 1; i < len - 1; i++)
			if (vm.v("lim-" + i).equals(val))
			{
				success = true;
				break;
			}
