...
public class Console
{
	public static void main (String[] argv)
	{
		...
		// Connect custom defined "gets" function
		vm.def("gets", new CustomGets());

		// Use autoUpdate() feature
		vm.autoUpdate();

		// Set qs21 built in thread loop to run with 0L delay
	...
	// New definition of "gets" function.
